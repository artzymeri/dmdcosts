  ...
  return (
    <div className="admin-add-client-form-container">
      <FormControl>
        ...
        >
          {presenter?.clientsList.length > 0 &&
      ...
      <FormControl>
        ...
        >
          {presenter?.employeesList.length > 0 &&
      ...
      <TextField
        ...
        focused={
          presenter.vm?.newCaseObject?.client_reference_number ? true : false
        }
      />
      <TextField
      ...
      <TextField
        ...
        focused={
          presenter.vm?.newCaseObject?.defendant_reference_number ? true : false
        }
      />
      <TextField
      ...
      <FormControlLabel
        control={
          <Switch
            checked={presenter.vm?.newCaseObject?.negotiable}
