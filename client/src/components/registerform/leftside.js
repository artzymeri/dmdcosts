  ...
  return (
    <div className="login-left-side">
      ...
      <TextField
        ...
        variant="outlined"
        value={presenter?.newUserData?.name_surname}
        onChange={(e) => {
      ...
      <TextField
        label="Emri Biznesit"
        variant="outlined"
        value={presenter?.newUserData?.business_name}
        onChange={(e) => {
      ...
      <TextField
        label="Adresa"
        variant="outlined"
        value={presenter?.newUserData?.location}
        onChange={(e) => {
      ...
      <TextField
        ...
        variant="outlined"
        value={presenter?.newUserData?.phone_number}
        onChange={(e) => {
      ...
      />
      <TextField
        label="Email Llogaria"
        variant="outlined"
        value={presenter?.newUserData?.email_address}
        onChange={(e) => {
      ...
      <TextField
        label="Fjalëkalimi"
        variant="outlined"
        value={presenter?.newUserData?.password}
        onChange={(e) => {
      ...
      <div className="login-left-side-registration-text">
